<template>
	<view class="message tn-safe-area-inset-bottom">
		...
		<view class="tn-margin-top-sm tn-padding-bottom-lg">
			...
			<!-- <view class="tn-flex tn-message-fixed">
				<view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
					<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
						...
						<view class="tn-color-black tn-text-center">
							<text class="tn-text-ellipsis">留 言</text>
						</view>
					</view>
				</view>
				<view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
					<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
						<view class="icon1__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur"
							style="background-color: #F3F2F7;color: #7C8191;">
							<view class="tn-icon-praise-simple">
							</view>
						</view>
						<view class="tn-color-black tn-text-center">
							<text class="tn-text-ellipsis">点 赞</text>
						</view>
					</view>
				</view>
				<view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
			...
			<view class="">
				<view class="" style="padding-top: 200rpx;">
					<view class="tn-flex tn-flex-col-top tn-margin tn-cat-shadow tn-padding">
						<view class="">
							<view
								class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur"
								style="background-color: #F3F2F7;color: #7C8191;">
			...
			<view class="tn-flex tn-flex-col-top tn-margin tn-cat-shadow tn-padding">
				...
				<view class="tn-padding-left-sm" style="width: 100%;">
					...
					<view class="tn-flex tn-flex-row-between tn-flex-col-between tn-margin-top-sm">
						<view class="justify-content-item tn-round tn-text-xs tn-bg-orangered--light tn-color-orangered"
							style="padding: 5rpx 15rpx;">
