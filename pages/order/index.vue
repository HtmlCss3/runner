	...
	<view class="oa-content">
		...
		<view class="" style="padding-bottom: 240rpx;">
			...
			<view class="tn-flex tn-flex-row-between tn-strip-bottom-min tn-padding" v-if="index==1">
				...
				<view class="justify-content-item tn-text-lg tn-color-grey" @click="tn('/pages/kuaidi/kuaidi')">
			...
			<view class="tn-flex tn-flex-row-between tn-strip-bottom-min tn-padding">
				...
				<view class="justify-content-item tn-text-lg tn-color-grey" @click="tn('/pages/address/address?lx=1')">
			...
			<view class="tn-flex tn-flex-row-between tn-strip-bottom-min tn-padding">
				...
				<view class="justify-content-item tn-text-lg tn-color-grey" @click="tn('/pages/coupon/coupon?lxid=1&money='+amount)">
