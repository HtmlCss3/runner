<template>
	<view class="template-payment">
		...
		<view class="" >
			...
			<view class="anniu">
				<tn-button backgroundColor="#000000" fontColor="#ffffff" shape="round" @click="quxiao()" v-if="ByData.orderShop.status==1">取消订单</tn-button>
			<tn-button backgroundColor="#000000" fontColor="#ffffff" shape="round" @click="qianshou()" v-if="ByData.orderShop.status==4">商品签收</tn-button>
			</view>
