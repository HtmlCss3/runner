	...
	<view class="oa-content">
		...
		<view class="" style="padding-bottom: 240rpx;">
			...
			<view class="tn-flex tn-flex-row-between tn-strip-bottom-min tn-padding">
				<view class="justify-content-item">
					...
					<view class="tn-color-gray tn-padding-top-xs">
						<input placeholder="请输入联系人" name="input" v-model="from.name" placeholder-style="color:#AAAAAA" value=""></input>
					</view>
				</view>
			</view>
			<view class="tn-flex tn-flex-row-between tn-strip-bottom-min tn-padding">
				<view class="justify-content-item">
					...
					<view class="tn-color-gray tn-padding-top-xs">
						<input placeholder="请输入手机号码" name="input" v-model="from.phone" placeholder-style="color:#AAAAAA" value=""></input>
					</view>
				</view>
			</view>
			...
			<view class="tn-bg-gray--light tn-padding" style="border-radius: 10rpx;margin: 0 30rpx 30rpx 30rpx;">
				<textarea maxlength="100" v-model="from.address" placeholder="请输入详细宿舍信息" placeholder-style="color:#AAAAAA"
